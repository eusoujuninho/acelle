...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="text-end">
            <a href="{{ action('Public\CampaignController@openLog', $campaign->uid) }}" class="btn btn-info bg-teal-600">{{ trans('messages.open_log') }} <span class="material-symbols-rounded">arrow_forward</span></a>
        </div>
        <br />
    </div>
    <div class="col-md-6">
        ...
        <div class="text-end">
            <a href="{{ action('Public\CampaignController@clickLog', $campaign->uid) }}" class="btn btn-info bg-teal-600">{{ trans('messages.click_log') }} <span class="material-symbols-rounded">arrow_forward</span></a>
        </div>
        <br />
    </div>
</div>
